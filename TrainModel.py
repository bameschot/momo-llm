...
parser.add_argument('--newModel', action='store_true',help= "indicates if a new model should be trained, if not the model file should be present in ./models/<model-name>/<model-name>.pth, a new model is stored in a folder with the same name")
...
print(f"Inpute data Characters {totalCharacters}")
print(f"Input data Tokens {totalTokens}")
